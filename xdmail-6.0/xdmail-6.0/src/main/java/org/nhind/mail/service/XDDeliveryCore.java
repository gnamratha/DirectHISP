...
public class XDDeliveryCore
{
	...
	private static final Log LOGGER1 = LogFactory.getFactory().getInstance(XDDeliveryCore.class);
       ...
       if (resolver.hasXdEndpoints(recipAddresses))
        {
            ...
            try
            {
                ...
                {
					String endpointUrl = resolver.getXdEndpoint(directTo);
