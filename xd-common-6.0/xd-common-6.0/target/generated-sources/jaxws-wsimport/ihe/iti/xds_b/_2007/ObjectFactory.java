...
public class ObjectFactory {
    ...
    private final static QName _ProvideAndRegisterDocumentSetBRequest_QNAME = new QName("urn:ihe:iti:xds-b:2007", "ProvideAndRegisterDocumentSet_bRequest");
    ...
    private final static QName _RegisterDocumentSetBResponse_QNAME = new QName("urn:ihe:iti:xds-b:2007", "RegisterDocumentSet-bResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:ihe:iti:xds-b:2007", name = "ProvideAndRegisterDocumentSet_bRequest")
    public JAXBElement<ProvideAndRegisterDocumentSetRequestType> createProvideAndRegisterDocumentSetBRequest(ProvideAndRegisterDocumentSetRequestType value) {
        return new JAXBElement<ProvideAndRegisterDocumentSetRequestType>(_ProvideAndRegisterDocumentSetBRequest_QNAME, ProvideAndRegisterDocumentSetRequestType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:ihe:iti:xds-b:2007", name = "RegisterDocumentSet-bResponse")
    public JAXBElement<RetrieveDocumentSetResponseType> createRegisterDocumentSetBResponse(RetrieveDocumentSetResponseType value) {
        return new JAXBElement<RetrieveDocumentSetResponseType>(_RegisterDocumentSetBResponse_QNAME, RetrieveDocumentSetResponseType.class, null, value);
    }
