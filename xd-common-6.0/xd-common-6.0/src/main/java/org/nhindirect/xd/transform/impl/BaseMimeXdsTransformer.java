...
public abstract class BaseMimeXdsTransformer implements MimeXdsTransformer {
    ...
    protected DirectDocuments.SubmissionSet getSubmissionSet(String subject, Date sentDate, String auth, Address[] recipients) throws Exception {
         ...
         */
        submissionSet.setContentTypeCode(Utils.GetDigitalHIEContentTypeCode(), true);
        ...
        submissionSet.setSourceId(Utils.GetDigitalHIESourceID()); // TODO: "UUID URN mapped by configuration to sending organization"
        submissionSet.setPatientId(Utils.GetDigitalHIEPatientID());
    ...
    protected DirectDocument2 getDocument(Date sentDate, String auth, String xdsMimeType, FormatCodeEnum xdsFormatCode, byte[] xdsDocument, BodyPart bodyPart) throws Exception {
        ...
        metadata.setSourcePatient(Utils.GetDigitalHIESimplePersion());
         ...
         */
        metadata.setClassCode(Utils.GetDigitalHIEClassificationCode());
         ...
         */
        metadata.setPatientId(Utils.GetDigitalHIEPatientID());
